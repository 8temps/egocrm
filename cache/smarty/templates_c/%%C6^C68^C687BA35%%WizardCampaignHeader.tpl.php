...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimage', 'modules/Campaigns/tpls/WizardCampaignHeader.tpl', 80, false),)), $this); ?>
		...
		<div class="template-panel-container panel">
			<div class="template-container-full">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<th  colspan="4"><h4><?php echo $this->_tpl_vars['MOD']['LBL_WIZ_NEWSLETTER_TITLE_STEP1']; ?>
 </h4></th>
					</tr>
		<tr>
