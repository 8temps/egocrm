<?php /* Smarty version 2.6.29, created on 2017-01-11 15:33:37
         compiled from cache/themes/SuiteR/modules/Project/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 52, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 58, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 61, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 64, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 116, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 639, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 718, false),array('function', 'sugar_number_format', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 773, false),array('function', 'sugar_getscript', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 1612, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 57, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 75, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 141, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/Project/EditView.tpl', 243, false),)), $this); ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='type_c_label' width='12.5%' data-total-columns="2" scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='estimated_start_date_label' width='12.5%' data-total-columns="2" scope="col">
...
<td valign="top" id='estimated_end_date_label' width='12.5%' data-total-columns="2" scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='show_datetime_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SHOW_DATETIME','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
...
<tr valign="middle">
<td nowrap>
<input autocomplete="off" type="text" id="<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
_date" class="datetimecombo_date" value="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['fields']['show_datetime_c']['name']]['value']; ?>
" size="11" maxlength="10" title='' tabindex="0" onblur="combo_<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
.update();" onchange="combo_<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
.update(); "    >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
<?php echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>
&nbsp;
</td>
<td nowrap>
<div id="<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
_time_section" class="datetimecombo_time_section"></div>
</td>
</tr>
</table>
<input type="hidden" class="DateTimeCombo" id="<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['fields']['show_datetime_c']['name']]['value']; ?>
">
...
"></script>
<script type="text/javascript">
var combo_<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
 = new Datetimecombo("<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['fields']['show_datetime_c']['name']]['value']; ?>
", "<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
", "<?php echo $this->_tpl_vars['TIME_FORMAT']; ?>
", "0", '', false, true);
//Render the remaining widget fields
text = combo_<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
.html('');
document.getElementById('<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
_time_section').innerHTML = text;

//Call eval on the update function to handle updates to calendar picker object
eval(combo_<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
.jsscript(''));
...
',"<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
_date",'date',false,"<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
");
...
YAHOO.util.Event.onDOMReady(function()
{
	...
	Calendar.setup ({
	onClose : update_<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
,
	inputField : "<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
_date",
    form : "EditView",
	ifFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
	daFormat : "<?php echo $this->_tpl_vars['CALENDAR_FORMAT']; ?>
",
	button : "<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
_trigger",
	singleClick : true,
	step : 1,
	weekNumbers: false,
        startWeekday: <?php echo ((is_array($_tmp=@$this->_tpl_vars['CALENDAR_FDOW'])) ? $this->_run_mod_handler('default', true, $_tmp, '0') : smarty_modifier_default($_tmp, '0')); ?>
,
	comboObject: combo_<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>

	});

	//Call update for first time to round hours and minute values
	combo_<?php echo $this->_tpl_vars['fields']['show_datetime_c']['name']; ?>
.update(false);

}); 
</script>
<td valign="top" id='budget_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BUDGET','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
...
<?php if (strlen ( $this->_tpl_vars['fields']['budget_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['budget_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['budget_c']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['budget_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['budget_c']['name']; ?>
...
<?php endif; ?>
<td valign="top" id='override_business_hours_label' width='12.5%' data-total-columns="2" scope="col">
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='contact_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['contact_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['contact_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['contact_c']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['contact_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['contact_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['account_id2_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['contact_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['contact_c']['name']; ?>
...
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['contact_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id2_c","name":"contact_c"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['contact_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['contact_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['contact_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['contact_c']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['contact_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL3','module' => 'Project'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='work_space_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_WORK_SPACE','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['work_space_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['work_space_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['work_space_c']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['work_space_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['work_space_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='dressing_rom_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DRESSING_ROM','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['dressing_rom_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['dressing_rom_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['dressing_rom_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['dressing_rom_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['dressing_rom_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['dressing_rom_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
</tr>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='floor_fix_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FLOOR_FIX','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['floor_fix_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['floor_fix_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['floor_fix_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['floor_fix_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['floor_fix_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['floor_fix_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
<td valign="top" id='sky_fix_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SKY_FIX','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['sky_fix_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['sky_fix_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['sky_fix_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['sky_fix_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['sky_fix_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['sky_fix_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
</tr>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='electricity_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ELECTRICITY','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['electricity_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['electricity_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['electricity_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['electricity_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['electricity_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['electricity_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
<td valign="top" id='sound_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SOUND','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['sound_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['sound_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['sound_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['sound_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['sound_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['sound_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
</tr>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='light_provider_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LIGHT_PROVIDER','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['light_provider_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['light_provider_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['light_provider_c']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['light_provider_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['light_provider_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['account_id_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['light_provider_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['light_provider_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['light_provider_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id_c","name":"light_provider_c"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['light_provider_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['light_provider_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['light_provider_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['light_provider_c']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL'), $this);?>
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['light_provider_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
<td valign="top" id='music_provider_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MUSIC_PROVIDER','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['music_provider_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['music_provider_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['music_provider_c']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['music_provider_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['music_provider_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['account_id1_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['music_provider_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['music_provider_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['music_provider_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"account_id1_c","name":"music_provider_c"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['music_provider_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['music_provider_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['music_provider_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['music_provider_c']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL'), $this);?>
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['music_provider_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='technical_detail_c_label' width='12.5%' data-total-columns="1" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TECHNICAL_DETAIL','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (empty ( $this->_tpl_vars['fields']['technical_detail_c']['value'] )): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['technical_detail_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['technical_detail_c']['value']); ?>
<?php endif; ?>
<textarea  id='<?php echo $this->_tpl_vars['fields']['technical_detail_c']['name']; ?>
' name='<?php echo $this->_tpl_vars['fields']['technical_detail_c']['name']; ?>
'
rows="4"
cols="80"
title='' tabindex="0" 
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL1','module' => 'Project'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='defrayed_drink_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEFRAYED_DRINK','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['defrayed_drink_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['defrayed_drink_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['defrayed_drink_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['defrayed_drink_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['defrayed_drink_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['defrayed_drink_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
<td valign="top" id='defrayed_food_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEFRAYED_FOOD','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['defrayed_food_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['defrayed_food_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['defrayed_food_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['defrayed_food_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['defrayed_food_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['defrayed_food_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
</tr>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='defrayed_travel_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEFRAYED_TRAVEL','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['defrayed_travel_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['defrayed_travel_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['defrayed_travel_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['defrayed_travel_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['defrayed_travel_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['defrayed_travel_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
<td valign="top" id='defrayed_night_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEFRAYED_NIGHT','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['defrayed_night_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['defrayed_night_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['defrayed_night_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['defrayed_night_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['defrayed_night_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['defrayed_night_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
</tr>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='event_insurance_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EVENT_INSURANCE','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['event_insurance_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['event_insurance_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['event_insurance_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['event_insurance_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['event_insurance_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['event_insurance_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
<td valign="top" id='event_advertising_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EVENT_ADVERTISING','module' => 'Project'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['event_advertising_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['event_advertising_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['event_advertising_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['event_advertising_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['event_advertising_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['event_advertising_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
</tr>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENCY','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'show_datetime_c_date\', \'date\', true,\'Show Date\' );
addToValidate(\'EditView\', \'event_insurance_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EVENT_INSURANCE','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'account_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LIGHT_PROVIDER_ACCOUNT_ID','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'music_provider_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MUSIC_PROVIDER','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'work_space_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_WORK_SPACE','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'technical_detail_c\', \'text\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TECHNICAL_DETAIL','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'defrayed_night_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEFRAYED_NIGHT','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'account_id2_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_ACCOUNT_ID','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'dressing_rom_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DRESSING_ROM','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'sound_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SOUND','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'defrayed_drink_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEFRAYED_DRINK','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'light_provider_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LIGHT_PROVIDER','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'defrayed_food_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEFRAYED_FOOD','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'electricity_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ELECTRICITY','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'contact_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MUSIC_PROVIDER_ACCOUNT_ID','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'floor_fix_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_FLOOR_FIX','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'defrayed_travel_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEFRAYED_TRAVEL','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'event_advertising_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EVENT_ADVERTISING','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'sky_fix_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SKY_FIX','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'budget_c\', \'currency\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_BUDGET','module' => 'Project','for_js' => true), $this);?>
<?php echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'music_provider_c\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Project','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MUSIC_PROVIDER','module' => 'Project','for_js' => true), $this);?>
<?php echo '\', \'account_id1_c\' );
addToValidateBinaryDependency(\'EditView\', \'light_provider_c\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Project','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LIGHT_PROVIDER','module' => 'Project','for_js' => true), $this);?>
<?php echo '\', \'account_id_c\' );
addToValidateBinaryDependency(\'EditView\', \'contact_c\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Project','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT','module' => 'Project','for_js' => true), $this);?>
<?php echo '\', \'account_id2_c\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_contact_c\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["contact_c","account_id2_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_light_provider_c\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["light_provider_c","account_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_music_provider_c\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["music_provider_c","account_id1_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>
