<?php /* Smarty version 2.6.29, created on 2017-01-12 11:51:28
         compiled from cache/themes/SuiteR/modules/EGO_Courses/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/EGO_Courses/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/themes/SuiteR/modules/EGO_Courses/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/EGO_Courses/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/EGO_Courses/SearchForm_basic.tpl', 81, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/EGO_Courses/SearchForm_basic.tpl', 104, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/EGO_Courses/SearchForm_basic.tpl', 119, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/EGO_Courses/SearchForm_basic.tpl', 106, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'EGO_Courses'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='ego_academicyear_ego_courses_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EGO_ACADEMICYEAR_EGO_COURSES_FROM_EGO_ACADEMICYEAR_TITLE','module' => 'EGO_Courses'), $this);?>
</label>
    	</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_courses_name_basic']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_courses_name_basic']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_courses_name_basic']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_coursesego_academicyear_ida_basic']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_coursesego_academicyear_ida_basic']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_courses_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_courses_name_basic']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"ego_academicyear_ego_coursesego_academicyear_ida_basic","name":"ego_academicyear_ego_courses_name_basic"}}'; ?>
...
</button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_courses_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_courses_name_basic']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['ego_academicyear_ego_coursesego_academicyear_ida_basic']['name']; ?>
...
"><?php echo smarty_function_sugar_getimage(array('name' => "id-ff-clear",'alt' => $this->_tpl_vars['app_strings']['LBL_ID_FF_CLEAR'],'ext' => ".png",'other_attributes' => ''), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='day_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DAY','module' => 'EGO_Courses'), $this);?>
</label>
    	</td>
...
<?php echo smarty_function_html_options(array('id' => 'day_basic','name' => 'day_basic[]','options' => $this->_tpl_vars['fields']['day_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['day_basic']['value']), $this);?>
