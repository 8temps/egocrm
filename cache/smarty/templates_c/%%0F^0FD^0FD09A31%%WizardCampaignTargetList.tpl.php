<?php /* Smarty version 2.6.29, created on 2017-01-12 12:30:42
         compiled from modules/Campaigns/tpls/WizardCampaignTargetList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_help', 'modules/Campaigns/tpls/WizardCampaignTargetList.tpl', 58, false),)), $this); ?>
<div class="template-panel">
	<div class="template-panel-container panel">
		<div class="template-container-full">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
	<th colspan="4" align="left" ><h4  style="border-bottom: solid 1px rgb(221, 221, 221);"><?php echo $this->_tpl_vars['MOD']['LBL_WIZ_NEWSLETTER_TITLE_STEP4']; ?>
</h4></th>
	</tr>
	<tr>
