...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.tutor_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_TUTOR' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.tutor_c.value) <= 0}
{assign var="value" value=$fields.tutor_c.default_value }
{else}
{assign var="value" value=$fields.tutor_c.value }
{/if} 
<span class="sugar_field" id="{$fields.tutor_c.name}">{$fields.tutor_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.assurance_name_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSURANCE_NAME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.assurance_name_c.value) <= 0}
{assign var="value" value=$fields.assurance_name_c.default_value }
{else}
{assign var="value" value=$fields.assurance_name_c.value }
{/if} 
<span class="sugar_field" id="{$fields.assurance_name_c.name}">{$fields.assurance_name_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.assurance_number_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSURANCE_NUMBER' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.assurance_number_c.value) <= 0}
{assign var="value" value=$fields.assurance_number_c.default_value }
{else}
{assign var="value" value=$fields.assurance_number_c.value }
{/if} 
<span class="sugar_field" id="{$fields.assurance_number_c.name}">{$fields.assurance_number_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.avs_numer_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_AVS_NUMER' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.avs_numer_c.value) <= 0}
{assign var="value" value=$fields.avs_numer_c.default_value }
{else}
{assign var="value" value=$fields.avs_numer_c.value }
{/if} 
<span class="sugar_field" id="{$fields.avs_numer_c.name}">{$fields.avs_numer_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.bank_name_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_BANK_NAME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.bank_name_c.value) <= 0}
{assign var="value" value=$fields.bank_name_c.default_value }
{else}
{assign var="value" value=$fields.bank_name_c.value }
{/if} 
<span class="sugar_field" id="{$fields.bank_name_c.name}">{$fields.bank_name_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
...
{if strlen($fields.bank_account_c.value) <= 0}
{assign var="value" value=$fields.bank_account_c.default_value }
{else}
{assign var="value" value=$fields.bank_account_c.value }
{/if} 
<span class="sugar_field" id="{$fields.bank_account_c.name}">{$fields.bank_account_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.bank_iban_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_BANK_IBAN' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.bank_iban_c.value) <= 0}
{assign var="value" value=$fields.bank_iban_c.default_value }
{else}
{assign var="value" value=$fields.bank_iban_c.value }
{/if} 
<span class="sugar_field" id="{$fields.bank_iban_c.name}">{$fields.bank_iban_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.www_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_WWW' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name=getLink assign=link}{$fields.www_c.value}{/capture}
{if !empty($link)}
{capture name=getStart assign=linkStart}{$link|substr:0:7}{/capture}
<span class="sugar_field" id="{$fields.www_c.name}">
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.facebook_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_FACEBOOK' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name=getLink assign=link}{$fields.facebook_c.value}{/capture}
{if !empty($link)}
{capture name=getStart assign=linkStart}{$link|substr:0:7}{/capture}
<span class="sugar_field" id="{$fields.facebook_c.name}">
<a href='{$link|to_url}' target='_self' >{$link}</a>
</span>
{/if}
{/if}
...
{capture name=getLink assign=link}{$fields.twitter_c.value}{/capture}
{if !empty($link)}
{capture name=getStart assign=linkStart}{$link|substr:0:7}{/capture}
<span class="sugar_field" id="{$fields.twitter_c.name}">
<a href='{$link|to_url}' target='_self' >{$link}</a>
</span>
{/if}
{/if}
