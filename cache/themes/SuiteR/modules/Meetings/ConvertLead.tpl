...
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="Meetingsdate_start_trigger"{/capture}
...
//addToValidate('{$form_name}',"Meetingsdate_start_date",'date',false,"Meetingsdate_start");
