...
addToValidate('EditView', 'currency_id', 'currency_id', false,'{/literal}{sugar_translate label='LBL_CURRENCY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'trip_costs_monthly_c', 'currency', false,'{/literal}{sugar_translate label='LBL_TRIP_COSTS_MONTHLY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'salary_per_hour_c', 'currency', false,'{/literal}{sugar_translate label='LBL_SALARY_PER_HOUR' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'salary_monthly_c', 'currency', false,'{/literal}{sugar_translate label='LBL_SALARY_MONTHLY' module='Users' for_js=true}{literal}' );
