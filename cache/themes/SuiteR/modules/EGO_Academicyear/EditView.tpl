...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='EGO_Academicyear'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='EGO_Academicyear'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_START' module='EGO_Academicyear'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_END' module='EGO_Academicyear'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_end.name}" id="{$fields.date_end.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='EGO_Academicyear' for_js=true}{literal}' );
...
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'date_start', 'date', true,'{/literal}{sugar_translate label='LBL_DATE_START' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'date_end', 'date', true,'{/literal}{sugar_translate label='LBL_DATE_END' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'promotion_web', 'text', false,'{/literal}{sugar_translate label='LBL_PROMOTION_WEB' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidate('EditView', 'public_web', 'bool', false,'{/literal}{sugar_translate label='LBL_PUBLIC_WEB' module='EGO_Academicyear' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='EGO_Academicyear' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='EGO_Academicyear' for_js=true}{literal}', 'assigned_user_id' );
</script>{/literal}
