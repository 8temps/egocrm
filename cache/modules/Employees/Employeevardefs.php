<?php 
 $GLOBALS["dictionary"]["Employee"]=array (
  ...
  array (
    ...
    'trip_costs_monthly_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'trip costs monthly',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'trip_costs_monthly_c',
      'vname' => 'LBL_TRIP_COSTS_MONTHLY',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'precision' => 6,
      'id' => 'Userstrip_costs_monthly_c',
      'custom_module' => 'Users',
    ),
    'salary_per_hour_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'salary per hour',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'salary_per_hour_c',
      'vname' => 'LBL_SALARY_PER_HOUR',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Userssalary_per_hour_c',
      'custom_module' => 'Users',
    ),
    'salary_monthly_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'salary monthly',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'salary_monthly_c',
      'vname' => 'LBL_SALARY_MONTHLY',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
